...
set -o xtrace # TODO: Remove logging secrets before creating a PR
...
export MONGODB_URI_WITH_MULTIPLE_MONGOSES="${MONGODB_URI:0:10}${SERVERLESS_ATLAS_USER}:${SERVERLESS_ATLAS_PASSWORD}@${MONGODB_URI:10}/?tls=true&compressors=$COMPRESSOR"
export MONGODB_URI="${MONGODB_SRV_URI:0:14}${SERVERLESS_ATLAS_USER}:${SERVERLESS_ATLAS_PASSWORD}@${MONGODB_SRV_URI:14}/?tls=true&compressors=$COMPRESSOR"
